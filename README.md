...
## Find all the columns the highest percentage of zeros. We can see after graphing the missing values that most of the columns that are missing a good percentage of hours are contractors(ctr).
